...
onMounted(() => {
  isSidebarOpen.value = localStorage.getItem("is-sidebar-open") === "true";
...
function toggleSidebar() {
  ...
  localStorage.setItem("is-sidebar-open", isSidebarOpen.value.toString());
}
</script>
  ...
  <div class="flex-1 flex">
    <div class="bg-base-100 transition-all duration-300" :class="{ 'w-64': isSidebarOpen, 'w-16': !isSidebarOpen }">
      ...
      <div class="flex flex-col">
        ...
        <div v-else-if="sidebarStore.sidebarItems.length > 0" class="flex flex-col">
          <SidebarButton
