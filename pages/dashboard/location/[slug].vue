...
<template>
  <div class="page-content-top">
    ...
    <div v-if="route.name === 'dashboard-location-slug' && location && !loading">
      ...
      <div v-if="location?.locationLogs.length" class="location-list">
        <LocationCard
    ...
    <AppDialog
      title="Are you sure?"
      description="Deleting this location will also delete all of the assocciated logs. This cannot be undone. Do you really want to do this?"
